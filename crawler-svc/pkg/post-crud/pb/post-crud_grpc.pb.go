...
type PostCRUDServiceClient interface {
	...
	List(ctx context.Context, in *ListPostRequest, opts ...grpc.CallOption) (*RequestResponse, error)
}
...
func (c *postCRUDServiceClient) List(ctx context.Context, in *ListPostRequest, opts ...grpc.CallOption) (*RequestResponse, error) {
	out := new(RequestResponse)
...
type PostCRUDServiceServer interface {
	...
	List(context.Context, *ListPostRequest) (*RequestResponse, error)
}
...
func (UnimplementedPostCRUDServiceServer) List(context.Context, *ListPostRequest) (*RequestResponse, error) {
...
var PostCRUDService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/post-crud/pb/post-crud.proto",
}
